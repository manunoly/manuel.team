...
const LINKS = [
  {
    title: "My GitHub",
    external: true,
    href: "https://github.com/manunoly",
    description: "I have been working in the software industry since 2007.",
  },
  {
    title: "Learn",
      ...
      <div className={styles.description}>
        ...
        <div>
          ...
          >
            Welcome to {" "}
            <div>
              <h1> Manuel<small style={{ fontSize: 15 }}>.team</small></h1>
            </div>
            <Image
              alt="Vercel Logo"
